...
CREATE TABLE "airports" (
	...
	"geog" "geography" GENERATED ALWAYS AS (ST_SetSRID(ST_MakePoint("airports"."lon", "airports"."lat"), 4326)::geography) STORED NOT NULL,
	"geom" geometry GENERATED ALWAYS AS (ST_SetSRID(ST_MakePoint("airports"."lon", "airports"."lat"), 4326)::geometry(Point,4326)) STORED NOT NULL
);
--> statement-breakpoint
